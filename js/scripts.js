...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        //  Backgroung .bg-img Page Section 
    ...
    // Magnific Popup for the carousel 
    ...
    var imageHeight = parseInt($('.header__ben-only').css('height')),
        ...
        //     $('.svc .svc-box').each(function(i){
        //         // for each element "i" found
        //         setTimeout(function(){
        //         $('.svc .svc-box').eq(i).addClass("animate__animated", "animate__fadeInRight");
        //         }, 150 * (i+1));
        //         });
        ...
        //             $('.svc .svc-box').eq(i).addClass('is-showing');
        //             // $(".svc-box").eq(i).removeClass("animate__animated", "animate__fadeInRight");
        //             });
        //         });

        // }

        // if(wScroll > $('.services').offset().top - ($(window).height() / 1.5)){
        ...
        if(wScroll > $('.about-scroll-0').offset().top - $(window).height()){
        //  -860
        var offset = Math.min(0, wScroll - $('.about-scroll-0').offset().top + $(window).height() -960);
    
        // $('bundle-macbookpro').css({'transform': 'translate('+ offset +'px, '+ Math.abs(offset * 0.5) + 'px)'});
        $('.bundle-macbookpro').css({'transform': 'translate('+ (offset * 0.7) + 'px, '+ (offset * 0) + 'px)'});
        }
    
        if(wScroll > $('.about-scroll-0').offset().top - $(window).height()){
        //  -880
        var offset = Math.min(0, wScroll - $('.about-scroll-0').offset().top + $(window).height() -980);
    
        $('.bundle-ipad').css({'transform': 'translate('+ (offset * -0.7) + 'px, '+ (offset * 0.22) + 'px)'});
    
        }
    
        if(wScroll > $('.about-scroll-0').offset().top - $(window).height()){
        //  -900
        var offset = Math.min(0, wScroll - $('.about-scroll-0').offset().top + $(window).height() -1000);
    
        $('.bundle-iphone').css({'transform': 'translate('+ (offset * -0.75) + 'px, '+ (offset * 0.5) + 'px)'});
    ...
    // element = .header__ben-only already defined at line 203
    // const element =  document.querySelector(".header__ben-only")
    
    // element.addEventListener("animationend", function() {     
    
    // element.classList.remove("animated", "fadeInLeft")
    // element.classList.remove(".header__ben-only-fade")
